...
export default function AssessmentPage() {
  ...
  const cardData = [
    ...
    },
    {
      ...
      description: "Understand how candidates will perform in real-world scenarios with our behavioral assessments.",
      image: "/images/behavioral-analysis.jpg",
    },
    {
      id: "3",
      title: "Cultural Fit Evaluation",
      description: "Ensure candidates align with your organization's values and work environment.",
      image: "/images/cultural-fit.jpg",
    },
    {
      id: "4",
      title: "Cognitive Ability Testing",
      description: "Measure problem-solving abilities, critical thinking, and learning potential.",
      image: "/images/cognitive-ability.jpg",
    },
    {
      id: "5",
      title: "Personality Profiling",
      description: "Gain insights into candidates' work styles, motivations, and interpersonal dynamics.",
  ...
  const assessmentTabs = [
    ...
    },
    {
      ...
      content: "Our assessment tools help eliminate bias and provide objective data to support your hiring decisions.",
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="flex flex-col-reverse md:flex-row items-center h-full py-12">
            <div className="w-full md:w-1/2 flex flex-col justify-start items-start gap-4 md:gap-6 z-10">
              ...
              <p className="text-white/90 text-base md:text-lg" style={{ fontFamily: "var(--font-regular)" }}>
                Our comprehensive assessment solutions help you evaluate candidates' technical skills, soft skills, and
                cultural fit to ensure you make the right hiring decisions every time.
              </p>
              <button
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-600" style={{ fontFamily: "var(--font-regular)" }}>
              We combine cutting-edge assessment tools with human expertise to provide a comprehensive evaluation of
              candidates, helping you identify the best talent for your organization.
            </p>
          </div>
      ...
      <section className="relative w-full py-24 bg-cover bg-center flex items-center justify-center">
        <Image src="/images/assessment-bg.png" alt="Assessment process visualization" fill className="object-cover" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/90 text-lg" style={{ fontFamily: "var(--font-regular)" }}>
              Our assessment solutions provide objective data and insights that help you identify candidates who will
              excel in their roles and contribute to your organization's success.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <CardStackContainer title="Our comprehensive assessment solutions" cards={cardData} defaultOpen={0} />
        </div>
      </section>
