...
export default function TemporaryWorkerPage() {
  ...
  const cardData = [
    {
      id: "1",
      title: "Flexibility",
      description: "Enjoy the freedom to choose when and where you work, creating a schedule that fits your lifestyle.",
      image: "/images/temp-flexibility.jpg",
    },
    {
      id: "2",
      title: "Diverse Experience",
      description: "Build a varied skill set by working in different roles, industries, and company cultures.",
      image: "/images/diverse-experience.jpg",
    },
    {
      id: "3",
      title: "Competitive Pay",
      description: "Access high-paying contract positions that often offer premium rates for specialized skills.",
      image: "/images/competitive-pay.jpg",
    },
    {
      id: "4",
      title: "Rapid Placement",
      description: "Get to work quickly with our streamlined process for temporary role placement.",
      image: "/images/rapid-placement.jpg",
    },
    {
      id: "5",
      title: "Potential for Permanence",
      description: "Many temporary positions can lead to permanent opportunities as you prove your value.",
      image: "/images/temp-to-perm.jpg",
    },
  ]
  ...
  const temporaryWorkTabs = [
    ...
    },
    {
      ...
      content: "Start in temporary roles that have the potential to convert to permanent positions.",
      image: "/images/talent-optimization/hands-together.png",
    },
    {
      title: "Specialized Contract Work",
      content: "Leverage your expertise in high-demand temporary roles that value your specialized skills.",
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="flex flex-col-reverse md:flex-row items-center h-full py-12">
            <div className="w-full md:w-1/2 flex flex-col justify-start items-start gap-4 md:gap-6 z-10">
              ...
              <p className="text-white/90 text-base md:text-lg" style={{ fontFamily: "var(--font-regular)" }}>
                Explore short-term and project-based roles that offer competitive rates, diverse experiences, and
                work-life balance tailored to your preferences.
              </p>
              <button
            ...
            <div className="w-full md:w-1/2 h-[300px] md:h-[500px] relative mb-8 md:mb-0">
              <Image
                src="/images/temporary-worker-hero.png"
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-600" style={{ fontFamily: "var(--font-regular)" }}>
              We connect professionals with rewarding temporary positions that offer flexibility, competitive pay, and
      ...
      <section className="relative w-full py-24 bg-cover bg-center flex items-center justify-center">
        <Image src="/images/temporary-worker-bg.png" alt="Flexible work environment" fill className="object-cover" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/90 text-lg" style={{ fontFamily: "var(--font-regular)" }}>
              Temporary work offers the flexibility to balance your career with other priorities while building a
              diverse portfolio of skills and experiences.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <CardStackContainer title="Benefits of temporary work" cards={cardData} defaultOpen={0} />
        </div>
      </section>
      ...
      >
        <div className="container mx-auto px-6">
          <InfoGraphics
            title="Find Your Next Temporary Role"
            description="Our extensive network and industry expertise help you find temporary positions that match your skills, experience, and lifestyle preferences. Let us help you take the next step in your flexible career journey."
            btnText="Talk to us"
