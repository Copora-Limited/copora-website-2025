...
import { Search, MapPin, Briefcase, Filter, Building, Calendar } from "lucide-react"
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                      <div className="md:w-16 md:h-16 flex-shrink-0 bg-gray-100 rounded-md flex items-center justify-center">
                        {job.image && job.image.thumbnail ? (
                          <ImageWithFallback
                            src={job.image.thumbnail.toString() || "/placeholder.svg"}
                      ...
                      <div className="flex-1">
                        ...
                        <h4 className="text-lg font-medium mb-2 hidden">{job.employer || "Company Name"}</h4>
                        ...
                        {job.requirements ? (
                          <div
                            className="text-gray-600 mb-4 requirements-content"
                            dangerouslySetInnerHTML={renderHtml(job.requirements)}
                          />
                        ) : (
                          <p className="text-gray-600 mb-4">No requirements available</p>
                        )}

                        <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                          <div className="text-lg font-semibold text-green-700 mb-2 sm:mb-0 hidden">
